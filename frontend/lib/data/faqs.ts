export const FAQS = [
  ...
  },
  {
    ...
    a: "July through October is prime for river crossings in the Maasai Mara. December through March places the herds in the southern Serengeti for calving season.",
  },
  {
    q: "Are your vehicles suitable for long safaris?",
    a: "Yes. Our 4x4 Land Cruisers are purpose-built for safari with pop-up roofs, cooler boxes and experienced driver-guides.",
  },
  {
    q: "Can you handle last-minute bookings?",
    a: "Absolutely. Reach out via the contact form and our team typically responds within 2 business hours.",
  },
  {
    q: "Is travel insurance included?",
    a: "Insurance is not included by default, but we'll recommend trusted partners and ensure your itinerary meets their requirements.",
  },
];
